 ...
 * @author chandra
 */
public class VideoRoomReceiver extends Bin{
    ...
    */
    public VideoRoomReceiver(String name, String ip, int port,
                ...
                public synchronized void padAdded(Element element, Pad pad) {
                        ...
                        if (pad.getName().startsWith("recv_rtp_src")) {
                            ...
                            if (pad.getName().contains(String.valueOf(ssrcToIgnore))) {
                                ...
                                VideoRoomReceiver.this.add(fakesink);
                                ...
                                VideoRtpDecodeBin decoder = new VideoRtpDecodeBin(true);

                                // add them
                                VideoRoomReceiver.this.add(decoder);
